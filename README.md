...
docker run --rm -it \
  ...
  -e TERM=xterm-256color \
  bjorn \
  bash -lc 'conda run -n bjorn nextflow run main.nf -profile docker --translate_mutations true --sampling false --fasta_dir /workspace/data/sc2/consensus_sequences --ref_file /workspace/data/sc2/NC_045512.2.fasta --query_ref_file /workspace/data/sc2/escape_BA.1_BA.2.fa --gff_file /workspace/data/sc2/NC_045512.2.gff --region NC_045512.2 --outdir /workspace/mutations/SC2/escape_BA.1_BA.2/ --chunk_size 20 -c nf.config'
```